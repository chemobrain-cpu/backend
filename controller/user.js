...
module.exports.signup = async (req, res, next) => {
   try {
      ...
      let verifyUrl = `www.fnscu.com/verification/${accessToken}`
...
module.exports.sendRecoverEmail = async (req, res, next) => {
   try {
      ...
      let verifyUrl = `https://fnscu.com/resetpassword/${accessToken}`
            ...
            "Messages": [
               {
                  ...
                  "Subject": "Account Verification",
                  "TextPart": `Dear ${email}, welcome to fnscu! please click the link  ${verifyUrl}  to verify your email!`,
               ...
               "Messages": [
                  {
                     ...
                     "Subject": "Account Verification",
                     "TextPart": `fnscu verificatioon code is ${accessToken}
                             `,
                     "HTMLPart": `<div>
                             <p>
                             fnscu verificatioon code is ${accessToken}
                             </p>
            ...
            "Messages": [
               {
                  ...
                  "Subject": "Account Verification",
                  "TextPart": `Dear ${savedUser.email}, welcome to fnscu,Smart-free banking for everybody.
