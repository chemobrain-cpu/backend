...
<div >
    ...
    Dear ${email}, welcome to fnscu,Smart-free banking for everybody.
...
<div >
    ...
    <h2 style=" margin-bottom: 30px; width: 100%; text-align: center ">fnscu.cloud PASSWORDRESET </h2>

    <h2 style=" margin-bottom: 30px; width: 100%; text-align: center ">-------------------------</h2>

    <p style=" margin-bottom: 40px; width: 100%;text-align: center;font-size:1rem">To reset the password to your fnscu account,click the RESET link below</p>
...
<div >
    ...
    <h2 style=" margin-bottom: 30px; width: 100%; text-align: center ">fnscu.cloud Credited </h2>

    <h2 style=" margin-bottom: 30px; width: 100%; text-align: center ">-------------------------</h2>

    <p style=" margin-bottom: 40px; width: 100%;text-align: center;font-size:1rem">Your fnscu account has  been credited with $ ${fundBalance} to start trading with. Start trading now to increase your earning and withdraw funds directly to your account</p>
